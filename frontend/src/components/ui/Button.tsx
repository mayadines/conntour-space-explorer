...
const styles = {
  ...
  icon: 'inline-flex items-center gap-2 p-2 text-gray-500 rounded-md hover:text-blue-600 hover:bg-gray-100 disabled:opacity-30 disabled:cursor-not-allowed transition-colors',
};
